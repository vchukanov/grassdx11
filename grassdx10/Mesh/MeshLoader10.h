...
struct Material
{
    ...
    WCHAR   strMapKd[MAX_PATH];
    ID3D10ShaderResourceView* pMapKdRV10;

    WCHAR   strMapKs[MAX_PATH];
    ID3D10ShaderResourceView* pMapKsRV10;
...
public:
    ...
    const D3DXMATRIX &GetNormalizeMt() const
    {
        return m_mNormalize;
    }
...
private:
    ...
    ID3D10Buffer *m_pVbuf;
    ID3D10Buffer *m_pIbuf;
