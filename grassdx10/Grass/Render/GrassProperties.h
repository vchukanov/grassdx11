...
{  
    ...
    UINT   uTexIndex;
    float3 vPad3;
    void Read ( ifstream &a_ifIn );
    GrassPropsType GetType() { return GRASSPROPSTYPE1; }
};
...
{  
    ...
    UINT   uTopTexIndex;
    void Read ( ifstream &a_ifIn );
    GrassPropsType GetType() { return GRASSPROPSTYPE3; }
};
...
public:
    GrassProperties         ( wstring a_sFileName )
    {
        ifstream ifStr;//(a_sFileName.c_str());
