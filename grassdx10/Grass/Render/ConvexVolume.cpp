...
namespace
{
	...
	__forceinline void GetFrustumNearPlane( FPlane& OutPlane, const D3DXMATRIXA16& M )
	{
		MakeFrustumPlane(
			M.m[0][2],
			M.m[1][2],
	...
	__forceinline void GetFrustumFarPlane( FPlane& OutPlane, const D3DXMATRIXA16& M )
	{
		MakeFrustumPlane(
			M.m[0][3] - M.m[0][2],
			M.m[1][3] - M.m[1][2],
	...
	__forceinline void GetFrustumLeftPlane( FPlane& OutPlane, const D3DXMATRIXA16& M )
	{
		MakeFrustumPlane(
			M.m[0][3] + M.m[0][0],
			M.m[1][3] + M.m[1][0],
	...
	__forceinline void GetFrustumRightPlane( FPlane& OutPlane, const D3DXMATRIXA16& M )
	{
		MakeFrustumPlane(
			M.m[0][3] - M.m[0][0],
			M.m[1][3] - M.m[1][0],
	...
	__forceinline void GetFrustumTopPlane( FPlane& OutPlane, const D3DXMATRIXA16& M )
	{
		MakeFrustumPlane(
			M.m[0][3] - M.m[0][1],
			M.m[1][3] - M.m[1][1],
	...
	__forceinline void GetFrustumBottomPlane( FPlane& OutPlane, const D3DXMATRIXA16& M )
	{
		MakeFrustumPlane(
			M.m[0][3] + M.m[0][1],
			M.m[1][3] + M.m[1][1],
...
void ConvexVolume::BuildFrustum( const D3DXMATRIXA16& viewProjectionMatrix )
{
	//viewProjection = viewProjectionMatrix;
	D3DXMATRIXA16 matrix;
	//Transpose(&matrix, viewProjectionMatrix);
    //D3DXMatrixTranspose(&matrix, &viewProjectionMatrix); - блядь
	BuildPlanes(viewProjectionMatrix);
	BuildPermutedPlanes();
}

void ConvexVolume::BuildNearAndFarPlanes( const D3DXMATRIXA16& ViewProjectionMatrix )
{
	FPlane	Temp;
...
void ConvexVolume::BuildPlanes( const D3DXMATRIXA16& ViewProjectionMatrix )
{
	FPlane	Temp;
