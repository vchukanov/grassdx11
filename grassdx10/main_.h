...
float                               g_fWindTexSpeed = 3.78f;
float                               g_fWindTexTile = 5.2f;
...
float                               g_fCameraMeshDist = 25.0f;//10

float                               g_fCarLength = 3.0;
float                               g_fCarHeight = 1.8;
float                               g_fCarFrontWidth = 2.8;
/*float                               g_fCarLength = 3;
float                               g_fCarHeight = 1;
float                               g_fCarFrontWidth = 2;
*/
float                               g_fCarBackWidth = 2;
